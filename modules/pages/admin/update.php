<?php
	...
	if (isset($_GET['id'])) 
	{
		...
		{
			mysql_query("UPDATE `pages` SET `title` = '".mysql_real_escape_string($_POST['title'])."', `content` = '".mysql_real_escape_string($_POST['content'])."'
...
<div class="container">
    ...
    <div class="col-md-9">
        <ul class="breadcrumbs breadcrumb">
            ...
            <li><a href="/modules/pages/admin/update.php?id=<?=$myrow['id']?>">Обновление страницы #<?=$myrow['id']?></a><span class="divider"></span></li>
        </ul>
        ...
        <form role="form" method="post">
            ...
            <div class="form-group">
                <textarea name="content" class="form-control ckeditor" placeholder="Введите содержание" id="editor" rows="10"><?=$myrow['content']?></textarea>
            </div>
