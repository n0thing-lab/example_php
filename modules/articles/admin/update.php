<?php
	...
	if (isset($_GET['id'])) 
	{
		...
		{
			mysql_query("UPDATE `articles` SET `title` = '".mysql_real_escape_string($_POST['title'])."', `content` = '".mysql_real_escape_string($_POST['content'])."'
...
<div class="container">
    ...
    <div class="col-md-9">
        <ul class="breadcrumbs breadcrumb">
            ...
            <li><a href="/modules/articles/admin/manage.php">Статьи</a><span class="divider"></span></li>
            <li><a href="/modules/articles/admin/update.php?id=<?=$myrow['id']?>">Обновление статьи #<?=$myrow['id']?></a><span class="divider"></span></li>
        </ul>
